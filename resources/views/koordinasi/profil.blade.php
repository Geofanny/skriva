...
<div class="bg-white p-6 rounded-xl shadow-lg mx-auto">
    <h2 class="text-xl font-bold text-gray-800 mb-6">Profil Koordinasi</h2>

    <form id="form-biodata" action="/koordinator/profil/update" method="POST" enctype="multipart/form-data">
        @csrf
