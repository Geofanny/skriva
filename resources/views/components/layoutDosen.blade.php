  ...
  <body class="h-screen flex bg-slate-900 text-white">
    ...
    <aside id="sidebar" class="w-64 bg-sidebar text-sm p-4 flex flex-col transition-all duration-300">
      <div class="flex items-center space-x-2 mb-6">
        ...
        <a href="/dosen"><span class="text-2xl font-bold">Skriva - Dosen</span></a>
      </div>
      <nav class="flex-1 overflow-y-auto">
        <hr>
        <p class="text-gray-400 uppercase text-xs mb-2">Pembimbing</p>
        <ul class="space-y-1">
          <li>
            ...
            <ul class="ml-6 mt-1 space-y-1 text-gray-300">
              <li><a href="/permintaanDosen" class="block p-1 pl-4 rounded hover:bg-slate-700">Permintaan Bimbingan</a></li>
              <li><a href="/jadwalDosen" class="block p-1 pl-4 rounded hover:bg-slate-700">Jadwal Bimbingan</a></li>
              <li><a href="/pengajuanBimbingan" class="block p-1 pl-4 rounded hover:bg-slate-700">Riwayat Bimbingan</a></li>
            </ul>
          </li>
          <li>
            <a href="#" class="flex items-center p-2 rounded hover:bg-slate-700">
            ...
            <ul class="ml-6 mt-1 space-y-1 text-gray-300">
              <li><a href="/daftarMahasiswa" class="block p-1 pl-4 rounded hover:bg-slate-700">Daftar Mahasiswa</a></li>
              {{-- <li><a href="/riwayatBimbingan" class="block p-1 pl-4 rounded hover:bg-slate-700">Riwayat Bimbingan</a></li> --}}
            </ul>
          </li>
          <li>
            <a href="#" class="flex items-center p-2 rounded hover:bg-slate-700">
              <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 7h18M3 12h18M3 17h18" /></svg>
              Sempro & Sidang
              <span class="ml-auto bg-orange-500 text-white text-xs px-2 py-0.5 rounded-full">Onprogress</span>
            </a>
          </li>
        </ul>
      </nav>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2 relative">
            ...
            <div id="dropdown" class="absolute right-0 top-10 bg-slate-800 rounded shadow-md p-4 w-48 hidden">
              <p class="font-semibold">Dr. Prof. Ahmad Suhendar M.M, M.Pd</p>
              <p class="text-sm text-gray-400 mb-2">NIP: 213190</p>
