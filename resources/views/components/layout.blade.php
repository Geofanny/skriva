        ...
        <ul class="space-y-1">
          <li>
            ...
            <ul class="ml-6 mt-1 space-y-1 text-gray-300">
              <li><a href="/pengajuanJudul" class="block p-1 pl-4 rounded hover:bg-slate-700">Pengajuan Judul</a></li>
              <li><a href="/pengajuanBimbingan" class="block p-1 pl-4 rounded hover:bg-slate-700">Pengajuan Bimbingan</a></li>
            </ul>
          </li>
          <li>
            <a href="#" class="flex items-center p-2 rounded hover:bg-slate-700">
            ...
            <ul class="ml-6 mt-1 space-y-1 text-gray-300">
              <li><a href="/bimbinganOnline" class="block p-1 pl-4 rounded hover:bg-slate-700">Bimbingan Online</a></li>
          ...
          <li>
            ...
            <ul class="ml-6 mt-1 space-y-1 text-gray-300">
              <li><a href="/detailDosen" class="block p-1 pl-4 rounded hover:bg-slate-700">Detail Dosen</a></li>
            </ul>
          </li>
          <li>
            <a href="#" class="flex items-center p-2 rounded hover:bg-slate-700">
